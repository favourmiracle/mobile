...
Before do |s|
  ...
  helper.start_with(appium_params) if start_appium?
...
def prepare_driver
  @configuration = { props: props, location: prepare_location, android: prepare_android }
  if android?
    prepare_android
  elsif ios?
    prepare_ios
...
def prepare_android
  #@configuration[package] = 'com.solaireresort.mysolairemobileapp.SolaireApplication'
